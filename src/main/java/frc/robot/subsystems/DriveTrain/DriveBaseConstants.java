...
public class DriveBaseConstants {
    ...
    public static final class PathPlanner {
        ...
        public static final PIDFGains XY_PID = new PIDFGains(5.5, 0.15, 0.1);//the pid gains for the pid controller of the robot's velocity, units are meters per second
    }
