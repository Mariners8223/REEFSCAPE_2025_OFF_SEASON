...
public class RobotAutoConstants {
        ...
        public static final Map<ElevatorConstants.ElevatorLevel, HomeToReefPIDXY> XY_PID_CONSTANTS =
                Map.of(
                        ...
                        ElevatorConstants.ElevatorLevel.L1, new HomeToReefPIDXY(9, 12, 0.7, XY_TOLERANCE, 0.1),
                        ElevatorConstants.ElevatorLevel.L2, new HomeToReefPIDXY(9, 12, 0.7, XY_TOLERANCE, 0.1),
                        ElevatorConstants.ElevatorLevel.L3, new HomeToReefPIDXY(9, 12, 0.7, XY_TOLERANCE, 0.1),
                        ElevatorConstants.ElevatorLevel.L4, new HomeToReefPIDXY(9, 12, 0.7, XY_TOLERANCE, 0.1)
                );
        ...
        public static final Map<ElevatorConstants.ElevatorLevel, HomeToReefPIDTheta> THETA_PID_CONSTANTS =
                Map.of(
                        ...
                        ElevatorConstants.ElevatorLevel.L4, new HomeToReefPIDTheta(6, 15, 0, THETA_TOLERANCE, THETA_IZONE)
                );
